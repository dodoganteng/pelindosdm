	...
	<form action="edit-proses.php" method="post">
		...
		<tr>
			<td>Substansi</td>
			<td>:</td>
			<td> <input type="text" name="substansi" size="30" required placeholder=<?php 
			echo $data['SUBSTANSI'] ?> /> </td>
		</tr>
		<tr>
			<td>Kelas Jabatan</td>
			<td>:</td>
			<td> <select name="kelas_jabatan" required placeholder=<?php 
			echo $data['KELAS_JABATAN'] ?> >
